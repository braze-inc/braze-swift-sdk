...
#define APPBOY_SDK_VERSION _ABKBRZCompat.sdkVersion
#endif
 ...
 */
BRZ_DEPRECATED("renamed to 'Braze'")
 ...
 */
- (void)shutdownServerCommunication __attribute__((unavailable("use the 'enabled' boolean property on the Braze instance to disable / enable the SDK.")));
 ...
 */
- (void)registerApplication:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)notification __attribute__((unavailable("BrazeKit / BrazeKitCompat doesn't provide support for this deprecated method. Push notifications support must be integrated using the 'UserNotifications' framework. See our push integration documentation for more details.")));
...
- (void)getActionWithIdentifier:(NSString *)identifier
          forRemoteNotification:(NSDictionary *)userInfo
              completionHandler:(nullable void (^)(void))completionHandler __attribute__((unavailable("BrazeKit / BrazeKitCompat doesn't provide support for this deprecated method. Push notifications support must be integrated using the 'UserNotifications' framework. See our push integration documentation for more details.")));
/*!
